...
namespace Assets.Scripts.WorldGeneration.Editor
{
	public class WorldGeneratorTest : MonoBehaviour
	{
		...
		public void AddPoolsToPaintedMap()
		{
			...
			{
				Color color = new(UnityEngine.Random.Range(0f,1), UnityEngine.Random.Range(0f, 1), UnityEngine.Random.Range(0f, 1));
		...
		[Button("Paint pools chunks by id")]
		public void AddPoolsByIdToPaintedMap()
		{
			Pool pool = _worldGenerator.WaterBehavior.Pools.ElementAt(PoolId);

				Color color = new(UnityEngine.Random.Range(0f, 1f), UnityEngine.Random.Range(0f, 1f), UnityEngine.Random.Range(0f, 1f));
