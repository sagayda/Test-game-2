...
{
    public class NoiseParametersSave
    {
        ...
        public void SaveNoiseParameters<T>(T parameters) where T : INoiseParameters
        {
        ...
        public T LoadNoiseParameters<T>() where T : INoiseParameters
        {
            string path = $@"{DEFAULT_PARAMETERS_PATH}{typeof(T).Name}.bs";
